...
<html>
  <head>
    <title>
      Min fantastiske nettside
    </title>
  </head>
  <body>
    Her er den kjempekulen nettsiden min.
    <div>
      Her er noe kult innhold, i en div.
    </div>
  </body>
</html>
```
...
Vi kan også gjøre skriften vår **fet**: `<b>`, eller *kursiv*: `<i>`, eller med <u>understrek</u>: `<u>`
...
#### Oppgave 1:
- Lag en enkel nettside, med disse forskjellige elementene over, som har noe tekstlig innhold og en tittel.
...
#### Oppgave 3:
- Legg til en enkel tabell på nettsiden din
...
<div>
  Kommentar:
  <textarea>
  </textarea> <!-- merk at denne må man lukke -->
</div>
```
...
Merk at om du sitter i CodePen, så vil ikke disse lenkene alltid fungere (med mindre man åpner i en ny fane!).
...
#### Oppgave 7:
- Legg til et bilde på nettsiden din
