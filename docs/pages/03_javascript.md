...
På samme måte som at vi brukte `id`-attributtet til å velge elementer, kan vi bruke `class`-attributtet til å velge _flere_ elementer.
...
man kan angi når man bruker den. Denne parameteren har vi gitt navnet `color`.
